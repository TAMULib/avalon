...
tamu_client_ip = request.env['HTTP_CF_CONNECTING_IP'] || request.env['REMOTE_ADDR'] || 'Unknown IP' 

	@current_ability ||= Ability.new(current_user, session_opts.merge(remote_ip: tamu_client_ip))
  end
